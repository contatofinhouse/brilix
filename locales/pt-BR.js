export default {
  ...
  "tabs": {
    ...
    "interior": "Melhorador de Interiores"
  },
  "uploader": {
  ...
  "headshot": {
    ...
    "resultDescription": "Refine sua imagem com edições inteligentes e, em seguida, compre a versão final.",
    "editing": "Aplicando edição...",
    "paymentProcessing": "Processando...",
    "editsTitle": "Edições Inteligentes (restam {{count}})",
    "noEdits": "Você usou todas as suas edições.",
    "editCatBackground": "Fundo",
    "editBgOfficeBright": "Escritório Iluminado",
    "editBgOutdoorNature": "Externo (Natureza)",
    "editBgStudioGrey": "Estúdio Cinza",
    "editCatAttire": "Vestuário",
    "editAttireFormal": "Tornar Mais Formal",
    "editAttireCasual": "Tornar Mais Casual",
    "editAttireColorDark": "Escurecer Roupas",
    "editCatLighting": "Iluminação",
    "editLightSoft": "Luz Suave",
    "editLightDramatic": "Luz Dramática",
    "editCatPolish": "Polimento e Estilo",
    "editExpressionSmile": "Sorrido Sutil",
    "editPolishSharp": "Aumentar Nitidez",
    "editPolishCinematic": "Visual Cinemático",
    "editPolishBW": "Preto e Branco",
    ...
    "paymentSuccessBody": "Sua imagem sem marca d'água e em alta resolução está pronta para download.",
    "errorGeneric": "Ocorreu um erro inesperado durante a geração.",
    "errorEdit": "Ocorreu um erro inesperado ao editar a imagem.",
