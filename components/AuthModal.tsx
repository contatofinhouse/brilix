...
const AuthModal: React.FC<AuthModalProps> = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="relative bg-base-200 rounded-lg shadow-xl w-full max-w-sm p-8 flex flex-col items-center"
